...
$(document).ready(function () {
  ...
  */
  ...
  if ((finalEnvyCount % 5 == 0) || (finalEnvyCount % 5 == 1) || (finalEnvyCount % 5 == 2) || (finalEnvyCount % 5 == 3)) {
  ...
  } else if (finalEnvyCount % 5 == 4) {
    console.log('Аэлита');
    dynamicPhone.forEach(function(element, i) {
      element.textContent = '+7 (800) 551-24-17';
      $(element).attr('href', 'tel:+78005512417');
    });

    $(envyElement).attr('src', 'https://cdn.envybox.io/widget/cbk.js?wcb_code=b6eaba6284192a88a11185a465a22104');
...
/*
    ...
    console.log('Артем');
    dynamicPhone.forEach(function(element, i) {
      element.textContent = '+7 (800) 551-64-90';
      $(element).attr('href', 'tel:+78005516490');
    });

    $(envyElement).attr('src', 'https://cdn.envybox.io/widget/cbk.js?wcb_code=54e6f0c8f26f462c309215d6e92ccff6');
  }
